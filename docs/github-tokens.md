...
| CAVATICA_TOKEN | rokitalab | NA | https://github.com/rokitalab/OpenPedCan-Project-CNH | build docker, build and push docker | build, build_and_push | Repository permissions: log into CAVATICA and push docker image. | 
| CAVATICA_USERNAME | rokitalab | NA | https://github.com/rokitalab/OpenPedCan-Project-CNH | build docker, build and push docker | build, build_and_push | Repository permissions: log into CAVATICA and push docker image. | 